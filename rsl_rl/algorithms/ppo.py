...
from rsl_rl.modules import ActorCritic, ActorCriticCNN, ActorCriticRecurrent, ActorCriticCrossMHA
...
class PPO:
    ...
    policy: ActorCritic | ActorCriticRecurrent | ActorCriticCNN | ActorCriticCrossMHA
